...
class TestAarpLgCopyTextVerification:
        ...
        for index in width:
            ...
            try:
                ...
                if driver.find_elements(
                    By.XPATH,
                    "//div[contains(@class,'cmp-experiencefragment--header_leadgen')]",
                ):
                    print("LeadGen nav bar is present in the landing page " + url)
                    self.common_functions.phone_number_verification(
                        driver, url, Global_Env_Data.LG_COPY_TEXT_VERIFICATION
                    )
                    ...
                    print(
                        "LeadGen and Membership nav bar is not present in the landing page "
                        + url
                    )
                    """ email sending  """
